...
def extract_data():
    ...
    vars_from_task = download_pdfs_from_year(YEAR_VARIABLE,"pyspark-glue-etl")   
    extract_texts(vars_from_task["keys"],vars_from_task["bucket"]) >> trigger_process_enem_pdf_glue_job(job_name='GlueETLJob')
